...
custom_text_splitter = CustomTextSplitter()
custom_split_docs = custom_text_splitter.split_documents(documents)
create_vector_store(custom_split_docs, "chroma_db_custom")
